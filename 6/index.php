...
<main id="js-page-content" role="main" class="page-content">
    ...
    <div class="row js-list-filter" id="js-contacts">
        ...
        <?php foreach ($arrCards as $key => $dataCard):?>
            <div class="col-xl-4">
                <div id="c_1" class="card border shadow-0 mb-g shadow-sm-hover"
                     data-filter-tags="<?php echo $dataCard['filter']; ?>">
                    <div class="card-body border-faded border-top-0 border-left-0 border-right-0 rounded-top">
                        <div class="d-flex flex-row align-items-center">
                                <span class="status <?php echo $dataCard['status']; ?> mr-3">
                                    <span class="rounded-circle profile-image d-block "
                                          style="background-image:url('/img/demo/avatars/<?php echo $dataCard['imgLink']; ?>'); background-size: cover;"></span>
                                </span>
                            <div class="info-card-text flex-1">
                                <a href="javascript:void(0);" class="fs-xl text-truncate text-truncate-lg text-info"
                                   data-toggle="dropdown" aria-expanded="false">
                                    <?php echo $dataCard['name']; ?>
                                ...
                                <span class="text-truncate text-truncate-xl"><?php echo $dataCard['position']; ?></span>
                            </div>
                    ...
                    <div class="card-body p-0 collapse show">
                        <div class="p-3">
                            <a href="tel:<?php echo $dataCard['tel']; ?>" class="mt-1 d-block fs-sm fw-400 text-dark">
                                <i class="fas fa-mobile-alt text-muted mr-2"></i> <?php echo $dataCard['tel']; ?></a>
                            <a href="mailto:<?php echo $dataCard['mailto']; ?>"
                               class="mt-1 d-block fs-sm fw-400 text-dark">
                                <i class="fas fa-mouse-pointer text-muted mr-2"></i> <?php echo $dataCard['mailto']; ?>
                            </a>
                            <address class="fs-sm fw-400 mt-4 text-muted">
                                <i class="fas fa-map-pin mr-2"></i> <?php echo $dataCard['address']; ?>
                            </address>
